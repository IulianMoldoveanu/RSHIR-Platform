...
export function VerticalBadge({ vertical }: { vertical: 'restaurant' | 'pharma' }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full border border-hir-border bg-zinc-800 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-zinc-100 ring-1 ring-inset ring-zinc-700/60">
