...
export function TenantBadge({ name }: { name: string | null }) {
  ...
  return (
    <span
      className="inline-flex max-w-[140px] items-center gap-1 truncate rounded-full bg-zinc-800 px-2 py-0.5 text-[11px] font-medium text-zinc-100 ring-1 ring-inset ring-zinc-700/60"
      title={name}
    >
