...
type CityOpt = { name: string; county: string | null; is_active: boolean };
    ...
    <>
      <tr className="hover:bg-hir-border/50">
        ...
        <td className="px-4 py-3 text-hir-muted-fg">
          {courier.city ? courier.city : <span className="text-amber-400">fără oraș</span>}
        </td>
        <td className="px-4 py-3">
          <span
          ...
          <td colSpan={5} className="px-4 py-4">
            ...
            >
              ...
              <label className="flex flex-col gap-1">
                ...
                <select name="to_city" defaultValue={courier.city ?? ''} className={SELECT_CLASS}>
