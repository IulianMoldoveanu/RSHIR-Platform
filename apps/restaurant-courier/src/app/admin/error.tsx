...
// Admin route group error boundary for the platform-admin fleet management
// surface (/admin/fleets/*). Same shape + tone as the dashboard + fleet
// boundaries so the platform operator never sees a blank Next.js error
// page in production — always a recoverable, branded card.
export default function AdminError({
  ...
  useEffect(() => {
    console.error('[courier/admin] runtime error', error);
  }, [error]);
  ...
  return (
    <div className="mx-auto mt-8 max-w-md rounded-2xl border border-rose-500/40 bg-rose-500/5 p-5 text-center">
      ...
      <p className="mt-1 text-xs text-zinc-400">
        Această pagină de administrare nu s-a putut încărca. Reîncearcă sau
