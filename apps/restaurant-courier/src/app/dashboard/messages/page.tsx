  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col gap-5">
      ...
      <section
        ...
        className="flex items-start gap-3 rounded-2xl border border-violet-500/30 bg-violet-500/10 p-4"
      >
        <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-violet-500/20 ring-1 ring-violet-500/40">
          <Wrench className="h-3.5 w-3.5 text-violet-200" aria-hidden />
        </span>
      ...
      <a
        href={phoneHref}
        className="flex min-h-[64px] items-center gap-3 rounded-2xl border border-hir-border bg-hir-surface px-4 py-3 transition-all hover:border-emerald-500/40 hover:bg-emerald-500/5 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-emerald-500 focus-visible:outline-offset-2"
      >
        <span
          aria-hidden
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-emerald-500/15 ring-1 ring-emerald-500/30"
        >
          <Phone className="h-5 w-5 text-emerald-300" />
        </span>
        <div className="min-w-0 flex-1">
          <p className="text-sm font-medium text-hir-fg">{phoneLabel}</p>
          <p className="mt-0.5 truncate text-xs tabular-nums text-hir-muted-fg">
            {phoneText}
          </p>
        </div>
        <ArrowRight className="h-4 w-4 shrink-0 text-hir-muted-fg" aria-hidden />
      </a>
      ...
      <Link
        href="/dashboard/help"
        className="inline-flex min-h-[44px] items-center gap-1.5 self-start rounded-lg px-3 text-xs font-medium text-violet-300 transition-colors hover:bg-violet-500/10 hover:text-violet-200 focus-visible:outline-2 focus-visible:outline-violet-500 focus-visible:outline-offset-2"
      >
