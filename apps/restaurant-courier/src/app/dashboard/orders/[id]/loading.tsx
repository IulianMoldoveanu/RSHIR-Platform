    ...
    <div className="mx-auto flex max-w-xl flex-col gap-5">
      ...
      <section className="rounded-2xl border border-violet-500/20 bg-hir-surface p-5">
        <div className="flex items-center gap-2">
          ...
          <div className="h-3 w-16 animate-pulse rounded bg-hir-border/70" />
        </div>
        <div className="mt-2 h-5 w-3/4 animate-pulse rounded bg-hir-border" />
        <div className="mt-3 flex gap-2">
          <div className="h-8 w-24 animate-pulse rounded-lg bg-hir-border" />
          <div className="h-8 w-20 animate-pulse rounded-lg bg-hir-border/70" />
        </div>
      </section>
        ...
        <div className="grid grid-cols-4 gap-1">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              <div className="h-2.5 w-full animate-pulse rounded-full bg-hir-border" />
              <div className="h-2 w-12 animate-pulse rounded bg-hir-border/70" />
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-emerald-500/20 bg-hir-surface p-5">
        ...
        <div className="mt-2 h-5 w-3/4 animate-pulse rounded bg-hir-border" />
        <div className="mt-1 h-3 w-1/3 animate-pulse rounded bg-hir-border/70" />
        <div className="mt-3 flex gap-2">
          <div className="h-8 w-24 animate-pulse rounded-lg bg-hir-border" />
          <div className="h-8 w-20 animate-pulse rounded-lg bg-hir-border/70" />
        </div>
      ...
      <section className="rounded-2xl border border-hir-border bg-hir-surface p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-4 w-20 animate-pulse rounded bg-hir-border" />
        </div>
      </section>

      {/* Action button */}
      <div className="h-14 w-full animate-pulse rounded-2xl bg-hir-border" />
    </div>
  );
}
