...
/**
 * Capacitor-aware preferences (key-value storage) shim for HIR Admin.
 *
 * Used for persisting dashboard state across native app restarts:
 * last-viewed tenant, KDS layout preference, notification opt-in state.
 *
