...
// Floating "Suport" button shown bottom-right on every dashboard route.
// Click → opens FeedbackModal (bug / sugestie / întrebare). Installs the
// console buffer on first render so the modal can attach the last
// console.error/warn lines.
