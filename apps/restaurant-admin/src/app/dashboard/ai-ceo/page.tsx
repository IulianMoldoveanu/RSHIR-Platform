import { Sparkles, MessageSquare, Activity, Lightbulb, Brain } from 'lucide-react';
...
export default async function AiCeoPage() {
  ...
  const [thread, runs, facts] = await Promise.all([
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        {/* 3. Suggestions awaiting approval (Phase 4 placeholder) */}
        ...
        {/* 4. Tenant facts the bot has learned */}
        <section className="rounded-xl border border-zinc-200 bg-white p-5">
          <div className="flex items-start justify-between">
            <div>
              <p className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wider text-zinc-500">
