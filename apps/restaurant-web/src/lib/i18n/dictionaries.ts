...
export const dictionaries = {
  ro: {
    ...
    track: {
      ...
      problem_link: 'A fost o problemă cu comanda?',
      problem_title: 'Spune-ne ce s-a întâmplat',
      problem_reason_missing: 'A lipsit ceva din comandă',
      problem_reason_wrong: 'Am primit altceva',
      problem_reason_late: 'A ajuns prea târziu',
      problem_reason_quality: 'Mâncarea nu era în regulă',
      problem_reason_courier: 'Ceva legat de curier',
      problem_reason_other: 'Altceva',
      problem_details_placeholder: 'Scrie pe scurt ce s-a întâmplat…',
      problem_email_placeholder: 'Emailul tău, ca să îți putem răspunde',
      problem_submit: 'Trimite sesizarea',
      problem_submitting: 'Se trimite…',
      problem_thanks: 'Am primit sesizarea. Revenim la tine pe email.',
      problem_error: 'Nu am putut trimite sesizarea. Încearcă din nou.',
    ...
    marketing: {
      ...
      home: {
        // 2026-08-01 — title/description rewritten off pricing language per
        ...
        stat_storefront_label: 'Ce primești',
        stat_storefront_value: 'Storefront propriu',
        stat_storefront_sub: 'brandul și numele tău, fără concurenți alături',
  ...
  en: {
    ...
    track: {
      ...
      problem_link: 'Something wrong with this order?',
      problem_title: 'Tell us what happened',
      problem_reason_missing: 'Something was missing',
      problem_reason_wrong: 'I received the wrong order',
      problem_reason_late: 'It arrived too late',
      problem_reason_quality: 'The food was not right',
      problem_reason_courier: 'Something about the courier',
      problem_reason_other: 'Something else',
      problem_details_placeholder: 'Briefly, what happened…',
      problem_email_placeholder: 'Your email, so we can reply',
      problem_submit: 'Send report',
      problem_submitting: 'Sending…',
      problem_thanks: 'We got it. We will reply by email.',
      problem_error: 'We could not send the report. Please try again.',
    ...
    marketing: {
      ...
      home: {
        ...
        stat_storefront_label: 'What you get',
        stat_storefront_value: 'Your own storefront',
        stat_storefront_sub: 'your brand and name, no competitors alongside you',
