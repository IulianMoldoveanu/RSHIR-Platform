...
// Shared Hepy brain — the NL classifier lives here so Telegram and WhatsApp
// use the SAME understanding. Types + detectIntentRegex + classifyIntentLLM
// were extracted verbatim from this file (2026-07-28); behavior is pinned by
// apps/restaurant-admin/src/lib/ai/hepy-brain.test.ts.
import {
  detectIntentRegex,
  classifyIntentLLM,
  type HepyIntent,
...
// HepyIntent / HepyPeriod / detectIntentRegex / classifyIntentLLM now live in
// ../_shared/hepy-brain.ts (imported above) so WhatsApp shares the exact same
// classifier. periodWindow + the grounded read handlers below remain here.
