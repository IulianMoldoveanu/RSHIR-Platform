...
export const KNOWN_INTENTS: RegistryEntry[] = [
  ...
  // Sprint 14 zone-pause write intents (PR builds on #730/#731/#732 zone-pause
  // surface): Hepy can "oprește Răcădău o oră" from chat. Default trust
  // PROPOSE_ONLY — patron approves first time, can elevate per category.
